...
if __name__=='__main__':
    ...
    for scenename in scene_test_list:
            ...
            input_data_file = os.path.join(gen_path,scenename)
            ...
            loss_collision, loss_contact = fop.eval_colllision()
            coll_loss_list += loss_collision
            cont_loss_list += loss_contact


    print('--collision_mean='+str(np.mean(coll_loss_list)))
    print('--contact_mean='+str(np.mean(cont_loss_list)))
